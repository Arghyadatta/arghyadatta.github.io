...
- Led science for **Amazon Q Code Developer Agent**, Amazon’s flagship GenAI coding assistant. [Company Announcement](https://aws.amazon.com/blogs/devops/amazon-q-developer-just-reached-a-260-million-dollar-milestone/)
- Code transformation for JDK migration, saving **4500 developer years**.
- Code transformation from AWS SDK v1 → v2, used widely across AWS Java applications.
...
- Developed a **customer ranking algorithm** deployed globally by Amazon.  
  _Published at Amazon ML Conference; contributed \$250,000 uplift (A/B test)._
- Developed a **multi-arm bandit targeting system**, achieving **8% lift** in key categories.
- Built the **Customer Segmentation Insights Tool** for profit-driving trends.
